    ...
    lines.forEach(function (line) {
        ...
        if (matches) {
            ...
            try {
                ...
                textLines.slice(errorLine - contextLinesCount, errorLine + contextLinesCount).forEach(function (line, i) {
...
module.exports = function (options) {
    ...
    return function (err, req, res, next) {
        if (err && err.stack) {
            err.stack = format(injectSourceLines(err.stack.split('\n'), contextLinesCount));
        }
